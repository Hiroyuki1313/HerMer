...
const ServicePage = () => {
  ...
  return (
    <div className="pt-8">
      ...
      {service.categories && id !== 'analisis-procesos' && id !== 'software' && (
        <section className="relative py-16 bg-white border-b border-neutral-100 overflow-hidden">
          {/* Subtle Light Grid */}
              ...
              {service.technologies && (
                <div className="lg:col-span-1">
                  <div className="mb-8">
                    ...
                    <h2 className="text-2xl font-black text-neutral-900 mt-2 uppercase tracking-tighter">Stack Moderno</h2>
                  </div>
                  <div className="grid grid-cols-2 gap-x-4 gap-y-6">
                    {service.technologies.map((tech, idx) => (
                      ...
                      >
                        <div className="w-10 h-10 rounded-xl bg-neutral-50 border border-neutral-100 flex items-center justify-center p-2 group-hover:bg-brand-light/5 transition-colors shrink-0">
                          {tech.logo ? (
                            <img 
                              src={tech.logo} 
                              alt={tech.name}
                        ...
                        <span className="text-[10px] font-black text-neutral-600 uppercase tracking-tight leading-tight">
                          {tech.name}
                        </span>
                      </motion.div>
                    ))}
          ...
          <Container className="relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {service.processes.map((step, idx) => (
                ...
                >
                  <div className="p-8 rounded-3xl bg-white border border-neutral-200 shadow-sm hover:border-brand-light/40 transition-all duration-300 h-full">
      ...
      {service.features && id !== 'analisis-procesos' && id !== 'software' && (
              ...
              {service.projects && (
                <div className="lg:col-span-1">
                  ...
                  >
                    ...
                    <h2 className="text-2xl font-black text-neutral-900 mt-2 uppercase tracking-tighter">Casos Reales</h2>
                  </motion.div>
      ...
      {(id === 'analisis-procesos' || id === 'software') && (
